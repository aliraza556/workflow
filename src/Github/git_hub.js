...
var fs_1 = require("fs");
var username = 'trilogy-group'; // Replace with your GitHub username
var repo = 'alpha-coach-bot'; // Replace with your repository name
var token = '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'; // Replace with your GitHub personal access token
...
function listPullRequestsAndComments() {
    return __awaiter(this, void 0, void 0, function () {
        var url, response, closedPullRequests, commentsPromises, commentsArrays, comments, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "https://api.github.com/repos/".concat(username, "/").concat(repo, "/pulls?state=closed");
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                ...
                case 2:
                    ...
                    commentsPromises = closedPullRequests.map(function (pr) {
