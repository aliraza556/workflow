...
function listPullRequestsAndComments() {
    return __awaiter(this, void 0, void 0, function () {
        var page, allClosedPullRequests, endDate, startDate, closedPullRequests, commentsPromises, commentsArrays, formattedComments, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    page = 1;
                ...
                case 5:
                    ...
                    (0, fs_1.writeFileSync)('test-3.json', JSON.stringify(formattedComments, null, 2));
                    console.log("Comments saved to test-2.json");
                    return [3 /*break*/, 7];
                case 6:
                    error_2 = _a.sent();
