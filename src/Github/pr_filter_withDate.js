...
var token = "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";
...
function listPullRequestsAndComments() {
    return __awaiter(this, void 0, void 0, function () {
        var page, allClosedPullRequests, endDate, startDate, url, response, closedPullRequests, commentsPromises, commentsArrays, formattedComments, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    page = 1;
                ...
                case 5:
                    ...
                    (0, fs_1.writeFileSync)('test-2.json', JSON.stringify(formattedComments, null, 2));
